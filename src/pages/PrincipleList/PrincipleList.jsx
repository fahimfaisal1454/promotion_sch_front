      ...
      <table className="min-w-full border-collapse">
        <thead>
          <tr className="bg-[#0A3B68] text-white">
            ...
            <th className="px-2 py-1  border border-slate-400">বক্তব্য</th>
          ...
          {teachers.length > 0 ? (
            teachers.map((t, index) => (
              <tr key={t.id || index} className="even:bg-gray-50 text-center">
                ...
                <td className="px-2 py-1  border border-slate-400 text-center">{t.speech}</td>
                <td className="px-2 py-1  border border-slate-400 text-center">
                  <div className="flex items-center justify-center gap-3 text-lg">
                    <Link
                      to={`/dashboard/addprinciple/${t.id}`}
