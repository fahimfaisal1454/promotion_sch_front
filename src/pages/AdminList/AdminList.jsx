...
export default function AdminList() {
    ...
    <div className="bg-gray-100 px-3 py-8">
      ...
      <h2 className="text-center text-xl mb-2">
        প্রশাসন কর্মকর্তাদের তালিকা ২০২৪
      </h2>
      ...
      {loading ? (
        ...
        <>
          <AdminTable teachers={teachers} handleDelete={handleDelete} />
        </>
      )}
    </div>
  );
...
function AdminTable({ teachers, handleDelete }) {
  return (
              ...
              <tr key={t.id || index} className="even:bg-gray-50 text-center">
                ...
                <td className="px-2 py-1  border border-slate-400 text-center">
                  <div className="flex items-center justify-center gap-3 text-lg">
                    <Link
                      to={`/dashboard/addcollegeadmin/${t.id}`}
